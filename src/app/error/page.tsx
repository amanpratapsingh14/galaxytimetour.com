...
export const metadata: Metadata = {
  title: "Error Page | Galaxy Time Tour",
  description: "This is Error Page galaxytimetour | gtt",
};
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                <div className="mx-auto text-center mb-9">
                  <svg  className="w-full mx-auto text-center"
                    height="210" viewBox="0 0 474 210"
                    fill="none"
